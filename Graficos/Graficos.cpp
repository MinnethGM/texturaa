...
int main()
{
	...
	coordenadaUVID =
		glGetAttribLocation(shader->getID(), "coodenadaUV");
	texturaUnoID =
		Shader::cargarBMP("texturas\\estrellas.png");
	...
	cuadrado->inicializarVertexArray(posicionID, colorID,ModeloID,vistaID,proyeccionID, coordenadaUVID,
